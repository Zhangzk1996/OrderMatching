            ...
            <div class="basic">
                    ...
                    <c:forEach var = "item" items = "${myNotice}" >
	                    <div class="changeinfo">
	                        ...
	                        <br/>
	                        <br/>
	                        <div class="commentTime" id="time" style="color:#b4b4b4; margin-left:400px">${item.createTime}</div>
	                       <%--  <div class="goodName" id="goodsName" style="color:#CD919E;margin-left:400px;font-size:normal">
	                        	 <a href="<%=basePath %>notice/deleteNotice/${item.id}" style="color:#CD919E;font-size:normal">删除</a>
	                        </div> --%>
	                    </div>
	                    <hr class="hr2"/>
	                </c:forEach>
