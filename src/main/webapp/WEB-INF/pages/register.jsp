...
<body>
	<div class="container">
		...
		<div class="container"
			style="width: 360px; border: 1px solid black; margin-top: 100px; border-radius: 5px; border-color: #00008B">
			<h1 class="text-center">Register</h1>
			<!-- action="../trader/addTrader" -->
			<form:form class="form-inline" method="post"
				onsubmit="return checkRegister()" action="../trader/addTrader"
				commandName="trader" role="form" style="margin-top: 60px;"
				id="myForm">
				<div class="form-group" style="padding-bottom: 20px;">
					<div class="col-md-6" style="width: 30px;">Name:</div>
					<div class="col-md-6" style="margin-left: 76px;">
						<input class="form-control" id="traderName" name="traderName"
							onblur="checkTraderName()" required="true" type="text" />
					</div>
					<div class="col-md-12">
						<p id="nameError"
							style="margin-bottom: -2px; color: red; margin-left: 110px;">
						</p>
					</div>
				</div>
				<div class="form-group" style="padding-bottom: 20px;">
					...
					<div class="col-md-6" style="margin-left: 76px;">
						<input class="form-control" id="email" name="email"
							onblur="checkEmail(this.value)" required="true" type="text" />
					</div>
					<div class="col-md-12">
						<p id="emailError"
							style="margin-bottom: -2px; color: red; margin-left: 110px;">
						</p>
						<c:if test="${!empty emailRegisted}">
							<p id="emailError2" style="margin-bottom: -2px; color: red; margin-left: 110px;">
								${emailRegisted}
							</p>
						</c:if>
					</div>
				...
				<div class="form-group" style="padding-bottom: 20px;">
					...
					<div class="col-md-6" style="margin-left: 76px;">
						<input class="form-control" id="password" name="password"
							onblur="checkPassword()" required="true" type="password" />
					</div>
					<div class="col-md-12">
						<p id="passwordError"
							style="margin-bottom: -2px; color: red; margin-left: 110px;">
				...
				<div class="form-group" style="padding-bottom: 20px;">
					...
					<div class="col-md-6" style="margin-left: 76px;">
						<input class="form-control" id="rePassword" name="rePassword"
							onblur="checkRepassword()" required="true" type="password" />
					</div>
					<div class="col-md-12">
						<p id="rePasswordError"
							style="margin-bottom: -2px; color: red; margin-left: 110px;">
						</p>
					</div>
				</div>
