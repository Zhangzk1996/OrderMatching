...
<div ng-controller="signupController" class="ng-scope">
    <div id="signup-show" class="signup stark-components">
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="../user/addUser" method="post" commandName="user" role="form" name="myForm">
                    <div class="input-field col s12">
                    ...
                    <div class="input-field col s12">
                        <input type="password" name="password" required="required" ng-minlength="5" class="validate ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" />
                        <label>密码</label>
                    </div>

                     <c:if test="${ifhave == false }">
    ...
    <c:if test="${ifhave == true }">
		<div ng-controller="changeNameController" class="ng-scope">
		    <div >
		        <div class="publish-box z-depth-4">
		            <div class="row">
		                <form:form action="" method="post" commandName="user" role="form">
		                    <div class="input-field col s12">
		                        <input type="text" name="username" required="required" id = "changename" value="该手机号已经被注册">
		                    </div>
		                    <div ng-show="checkTelIsShow" class="col s12">
        ...
        <div class="publish-box z-depth-4">
            <div class="row">
                ...
                <form:form action="../user/changeName" method="post" commandName="user" role="form">
                    <div class="input-field col s12">
                        <input type="text" name="username" required="required" id = "changename" class="validate ng-pristine ng-empty ng-invalid ng-invalid-required ng-valid-pattern ng-touched" />
                        <label>修改用户名</label>
                    </div>
                    <div ng-show="checkTelIsShow" class="col s12">
                        <button class="waves-effect waves-light btn publish-btn red lighten-1">
...
<div ng-controller="sidebarController" class="sidebar stark-components ng-scope">
   <li ng-class="{true: 'active'}[isAll]">
        <a href="<%=basePath%>goods/catelog/1" class="index">
            <img src="<%=basePath%>img/newupdate.png">
            <em>最新发布</em>
        </a>
    </li>
    <li ng-class="{true: 'active'}[isDigital]">
        <a href="<%=basePath%>goods/catelog/1" class="digital">
            <img src="<%=basePath%>img/camera.png"  />
            <em>数码科技</em>
        </a>
    </li>
    ...
    <li ng-class="{true: 'active'}[isCommodity]">
        <a href="<%=basePath%>goods/catelog/3" class="commodity">
            <img src="<%=basePath%>img/littlething.png"/>
            <em>日用小物</em>
        </a>
    </li>
    ...
    <li ng-class="{true: 'active'}[isSmallthing]">
        <a href="<%=basePath%>goods/catelog/7" class="smallthing">
            <img src="<%=basePath%>img/card.png"/>
            <em>票券卡片</em>
        </a>
    </li>
    <div class="info">
         <a href="" target="_blank">关于我</a><em>-</em>
        <a href="">联系我</a>
        <a href="https://mail.163.com/">dengyalan666@163.com</a>
    </div>
</div>
<!--
    描述：右侧显示部分
                    ...
                    <a href="">
                        <div class="bannerimg">
                            <ul class="bannerul">
                                ...
                                <p class="text2">欢迎</p>
                                <p class="text3">来到SCU-secondhand market</p>
                            </ul>
                            <div class="logoimg">
