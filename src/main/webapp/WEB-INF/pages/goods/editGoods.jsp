...
<div id="cover" style="min-height: 639px;">
    <div id="user_area">
        ...
        <div id="user_content">
            <div class="basic">
                <form action="<%=basePath %>goods/editGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                   ...
                   <div class="changeinfo">
                     ...
                     <div class="changeinfo">
                        ...
                        <select class="in_info" name="catelogId">
                            ...
                            <option value="3">日用小物</option>
                            <option value="4">图书教材</option>
                            <option value="5">美妆衣物</option>
                            <option value="6">运动装备</option>
                            <option value="7">票券卡片</option>
                        </select>
                    </div>
